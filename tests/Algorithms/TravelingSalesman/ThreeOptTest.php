...
class ThreeOptTest extends AbstractTravelingSalesmanTest
{
    /**
    ...
    public function testCompute($syntax, $expected)
    {
        ...
        $algorithmTravelingSalesman = new Algorithms\TravelingSalesman\ThreeOpt();
    ...
    public function providerTestComputeTwoOpt()
    {
        ...
        $tests['simple 6'][]    = array('length' => 57041,  'route' => '(0,2)->(2,0)->(3,2)->(3,5)->(3,9)->(4,15)->(3,12)->(4,4)->(2,7)->(0,11)');
        $tests['huge 1'][]      = array('length' => 240325, 'route' => '(0,1)->(2,3)->(2,7)->(1,9)->(2,19)->(1,25)->(5,23)->(8,25)->(8,41)->(13,41)->(12,51)->(10,53)->(13,57)->(8,57)->(2,61)->(9,61)->(9,71)->(10,73)->(14,75)->(12,77)->(9,77)->(5,77)->(1,73)->(6,73)->(9,67)->(12,67)->(13,9)->(12,3)');
        $tests['huge 2'][]      = array('length' => 262752, 'route' => '(0,2)->(12,0)->(12,7)->(10,11)->(8,12)->(12,16)->(8,18)->(10,27)->(3,37)->(13,25)->(13,21)->(14,20)->(18,5)->(19,36)->(19,47)->(17,48)->(19,52)->(14,68)->(15,75)->(13,66)->(7,64)->(5,59)->(3,69)->(18,69)->(19,79)');
